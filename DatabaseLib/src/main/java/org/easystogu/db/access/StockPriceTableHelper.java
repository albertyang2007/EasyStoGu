...
public class StockPriceTableHelper {
    ...
    protected String UPDATE_PRICE_BASED_ON_GAOSONGZHUAN_AND_DATE = "UPDATE " + tableName
    ...
    public void updateGaoSongZhuanPrice(GaoSongZhuanVO vo) {
        try {
            MapSqlParameterSource namedParameters = new MapSqlParameterSource();
            ...
            namedParameterJdbcTemplate.execute(UPDATE_PRICE_BASED_ON_GAOSONGZHUAN_AND_DATE, namedParameters,
                    new DefaultPreparedStatementCallback());
        } catch (Exception e) {
            e.printStackTrace();
        }
