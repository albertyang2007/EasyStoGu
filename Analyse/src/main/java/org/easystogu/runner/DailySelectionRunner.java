...
public class DailySelectionRunner implements Runnable {
	...
	public void reportToConsole(List<RangeHistoryReportVO> rangeList) {
		...
		for (RangeHistoryReportVO rangeVO : rangeList) {
			...
			System.out.println(rangeVO.toSimpleString() + " WeekLen(" + rangeVO.currentSuperVO.hengPanWeekLen + ") KDJ("
					+ (int) rangeVO.currentSuperVO.kdjVO.k + ") " + rangeVO.currentSuperVO.genZiJinLiuInfo() + " "
