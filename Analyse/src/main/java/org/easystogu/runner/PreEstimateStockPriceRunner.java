...
public class PreEstimateStockPriceRunner implements Runnable {
    ...
    private void injectNextDateMockStockPrice() {
    ...
    public void run() {
        ...
        try {
            ...
            //update currentDate based on latest stockprice date
            currentDate = stockPriceTable.getLatestStockDate();
            nextDate = WeekdayUtil.nextWorkingDate(currentDate);

            // mock next day price
            injectNextDateMockStockPrice();
