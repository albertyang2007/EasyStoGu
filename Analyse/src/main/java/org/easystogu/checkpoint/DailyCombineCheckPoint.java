...
public enum DailyCombineCheckPoint {
    MACD_Gordon("Simple MACD Gordon Buy Point", 0, 0), KDJ_Gordon("Simple KDJ Gordon Buy Point", 0, 0), MACD_KDJ_Gordon_3_Days_Red_MA_Ronghe_XiangShang(
            ...
            13.46), Day_MACD_KDJ_Gordon_Week_KDJ_Gordon("", 3246, 6.11), Day_MACD_KDJ_Gordon_Week_MACD_Gordon("", 4537,
            6.56), Phase1_Previous_Under_Zero_MACD_Gordon_Now_MACD_Dead_KDJ_Zero("", 0, 0), Phase2_Previous_Under_Zero_MACD_Gordon_Now_MACD_Dead_RSV_KDJ_Gordon(
            ...
            "Duo Tou, MA5<=MA10, MA10>=MA20>=MA30, pre2 pre3 two days green, pre1 and today red, pre1 low < ma20, pre1 close > ma20, pre 1 KDJ J is low 10, now RSV gordon",
            1600, 7.95), DuoTou_Pre_2_Days_Green_Red_KDJ_Zero_MA30_Support_MA_RongHe_XiangShang(
            "same as above with MA ronghe XiangShang", 154, 8.12), DuoTou_Pre_2_Days_Green_Red_KDJ_Zero_MA20_Support_MA_RongHe_XiangShang(
            "same as above with MA ronghe XiangShang", 283, 7.95), DuoTou_HuiTiao_Boll_Lower_Support_MA30_Support_MA_RongHe_XiangShang(
            "DuoTou huitiao, KDJ J zero, boll lower support, ma30 support, MA5,10,20,30 ronghe, MB support", 121, 7.97), DuoTou_HuiTiao_Boll_MB_Support_MA20_Support_MA_RongHe_XiangShang(
            "DuoTou huitiao, boll mb support, ma20 support, MA5,10,20 ronghe, MB support", 761, 6.83), DuoTou_HuiTiao_RSV_Gordon_MA10_Support_MA_RongHe_XiangShang(
            "DuoTou Huitiao, MA10 support, KDJ Dead, KDJ Gordon, MA5,MA10 ronghe xiangShang", 1900, 99.537), DuoTou_MA5_Wait_MA10_RSV_KDJ_Gordon_Break_Platform(
            ...
            "Volume and Price is the highest in half year(ma120)", 1622, 8.14), KDJ_Gordon_Volume_And_Price_Highest_In_MA90(
            ...
            "Volume is biggest in 120 days and price higher than ma120, pre1 day low ma120", 221, 8.86), Volume_Increase_Higher_MA120(
