...
public enum DailyCombineCheckPoint {
    MACD_Gordon(SellPointType.MACD_Dead, 0, 0), MACD_Dead(SellPointType.MACD_Dead, 0, 0), KDJ_Gordon(
            ...
            SellPointType.KDJ_Dead, 72112, 10.17),WR_Top_Area(SellPointType.KDJ_Dead, 0, 0), MACD_DI_BeiLi(SellPointType.KDJ_Dead, 0, 99.0),WR_4_Days_SameValue_XianShang(SellPointType.KDJ_Dead,2923,8.35);
