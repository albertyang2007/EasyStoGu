...
public enum DailyCombineCheckPoint {
    MACD_Gordon(SellPointType.MACD_Dead, 0, 0), MACD_Dead(SellPointType.MACD_Dead, 0, 0), KDJ_Gordon(
    		...
    		LuZao_PhaseII_MACD_WEEK_GORDON_MACD_DAY_DIF_BIGGER_0(SellPointType.KDJ_Dead, 0, 99.0),
    		LuZao_PhaseIII_MACD_WEEK_GORDON_MACD_DAY_DIF_BIGGER_0(SellPointType.KDJ_Dead, 0, 99.0);
