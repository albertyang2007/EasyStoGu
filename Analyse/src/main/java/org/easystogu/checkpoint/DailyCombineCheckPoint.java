...
public enum DailyCombineCheckPoint {
	MACD_KDJ_Gordon_3_Days_Red("Macd & KDJ Gordon, 3 days Red, Volume bigger", 3035, 7.57), MACD_KDJ_Gordon_Pre_3_Days_Green(
			...
			6.43), Phase1_Previous_Under_Zero_MACD_Gordon_Now_MACD_Dead_KDJ_Zero("", 0, 0), Phase2_Previous_Under_Zero_MACD_Gordon_Now_MACD_Dead_RSV_KDJ_Gordon(
			"First MACD Gordon is under zero, now MACD is Dead above zero, but RSV/KDJ is Gordon", 515, 8.15), Phase3_Previous_Under_Zero_MACD_Gordon_Now_MACD_Dead_KDJ_Gordon(
			"First MACD Gordon is under zero, now MACD is Dead above zero, but KDJ is Gordon", 11891, 6.15), Phase3_Previous_Under_Zero_MACD_Gordon_Now_MACD_Gordon_Volume_Bigger(
			...
			102, 7.86), Huge_Volume_Increase_3X3_Price_Higher_All_MA120(
