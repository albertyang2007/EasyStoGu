...
public enum DailyCombineCheckPoint {
	HengPang_Ready_To_Break_Platform_MA30_Support_MA_RongHe_XiangShang(SellPointType.KDJ_Dead, 19, 19.0), HengPang_Ready_To_Break_Platform_MA20_Support_MA_RongHe_XiangShang(
			...
			SellPointType.KDJ_Dead, 665, 8.63), HengPang_Ready_To_Break_Platform(SellPointType.KDJ_Dead, 4252, 9.57), Close_Higher_BollUp_BollXueShi2_Dn_Gordon(
			SellPointType.KDJ_Dead, 17000, 8.87), MACD_Gordon(SellPointType.MACD_Dead, 99400, 10.6), KDJ_Gordon(
			SellPointType.KDJ_Dead, 210114, 6.0), ShenXian_Gordon(SellPointType.ShenXian_Dead, 72577, 12.75 - 12.75), ShenXian_Two_Gordons(
			...
			SellPointType.KDJ_Dead, 146, 8.8);
