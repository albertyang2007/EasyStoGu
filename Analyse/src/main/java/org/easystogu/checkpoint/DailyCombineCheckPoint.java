...
public enum DailyCombineCheckPoint {
	MACD_Gordon(SellPointType.KDJ_Dead, 0, 0), KDJ_Gordon(SellPointType.KDJ_Dead, 0, 0), MACD_KDJ_Gordon_3_Days_Red_MA_Ronghe_XiangShang(
			...
			SellPointType.KDJ_Dead, 715, 7.56), KDJ_Near_Gordon_High_MA5_MA10_BOLL(SellPointType.KDJ_Dead, 2091, 7.19), RSV_Gordon_High_MA5_MA10_BOLL(
			...
			SellPointType.KDJ_Dead, 154, 8.12), DuoTou_Pre_2_Days_Green_Red_KDJ_Zero_MA20_Support_MA_RongHe_XiangShang(
			SellPointType.KDJ_Dead, 283, 7.95), DuoTou_HuiTiao_Boll_Lower_Support_MA30_Support_MA_RongHe_XiangShang(
			SellPointType.KDJ_Dead, 121, 7.97), DuoTou_HuiTiao_Boll_MB_Support_MA20_Support_MA_RongHe_XiangShang(
			SellPointType.KDJ_Dead, 761, 6.83), DuoTou_HuiTiao_RSV_Gordon_MA10_Support_MA_RongHe_XiangShang(
			SellPointType.KDJ_Dead, 360, 6.10), DuoTou_MA5_Wait_MA10_RSV_KDJ_Gordon_Break_Platform(
			SellPointType.KDJ_Dead, 102, 6.92), DuoTou_MA5_Wait_MA10_RongHe(SellPointType.KDJ_Dead, 315, 5.86), Huge_Volume_Increase_3X3_Price_Higher_All_MA120(
			SellPointType.KDJ_Dead, 168, 7.81), MACD_Gordon_Volume_And_Price_Highest_In_MA90(SellPointType.KDJ_Dead,
			1622, 8.14), KDJ_Gordon_Volume_And_Price_Highest_In_MA90(SellPointType.KDJ_Dead, 1928, 6.70), Huge_Volume_Increase_Price_Higher_MA120_Previous_Lower_MA120(
			...
			6.37), LaoYaZhui_TuPo_MA60_Day_Under_Zero_MACD_Gordon_KDJ_Gordon_Week_KDJ_Gordon(SellPointType.KDJ_Dead, 0,
			99.0);
