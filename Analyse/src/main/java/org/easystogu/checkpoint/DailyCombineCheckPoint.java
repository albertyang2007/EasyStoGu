...
public enum DailyCombineCheckPoint {
    MACD_Gordon(SellPointType.MACD_Dead, 99400, 10.6 - 10.6), KDJ_Gordon(SellPointType.KDJ_Dead, 210114, 6.0 - 6.0), ShenXian_Gordon(
            ...
            SellPointType.KDJ_Dead, 128, 10.19), HengPan_2_Weeks_2_Days_Green_RSV_KDJ_Gordon_RongHe_XiangShang_Break_Platform(
            SellPointType.KDJ_Dead, 571, 8.20), HengPan_1_Weeks_4_Days_JiBu_Break_Platform(SellPointType.KDJ_Dead, 0,
            99), Huge_Volume_Increase_3X3_Price_Higher_All_MA120(SellPointType.KDJ_Dead, 146, 7.7), MACD_Gordon_Volume_And_Price_Highest_In_MA90(
            ...
            SellPointType.KDJ_Dead, 5408, 6.48), ShenXian_Two_Gordons(SellPointType.KDJ_Dead, 25835, 5.6), HengPang_Ready_To_Break_Platform(
            SellPointType.KDJ_Dead, 4835, 9.22), GaoSongZhuan_TianQuan(SellPointType.KDJ_Dead, 0, 99);
