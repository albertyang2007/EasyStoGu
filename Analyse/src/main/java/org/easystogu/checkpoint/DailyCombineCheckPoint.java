...
public enum DailyCombineCheckPoint {
	MACD_Gordon(SellPointType.MACD_Dead, 99400, 10.6 - 10.6), KDJ_Gordon(SellPointType.KDJ_Dead, 210114, 6.0 - 6.0), ShenXian_Gordon(
			...
			SellPointType.KDJ_Dead, 96, 10.87), HengPan_2_Weeks_2_Days_Green_RSV_KDJ_Gordon_RongHe_XiangShang_Break_Platform(
			SellPointType.KDJ_Dead, 508, 8.40), HengPan_1_Weeks_4_Days_JiBu_Break_Platform(SellPointType.KDJ_Dead, 0,
