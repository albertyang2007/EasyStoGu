...
public enum DailyCombineCheckPoint {
    MACD_Gordon(SellPointType.MACD_Dead, 99400, 10.6), KDJ_Gordon(SellPointType.KDJ_Dead, 210114, 6.0), ShenXian_Gordon(
            ...
            17000, 8.87), HengPang_Ready_To_Break_Platform_MA30_Support_MA_RongHe_XiangShang(SellPointType.KDJ_Dead, 0,
            99), HengPang_Ready_To_Break_Platform_BollUp_BollXueShi2_Dn_Gordon(SellPointType.KDJ_Dead, 0, 99);
