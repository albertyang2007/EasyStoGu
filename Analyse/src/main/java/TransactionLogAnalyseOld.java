...
public class TransactionLogAnalyseOld {
	...
	public void displayResult() {
		...
		if (nofResult[4] > 0)
			System.out.println("Number:" + nofResult[5] + ", Total Delay:" + nofResult[0] / nofResult[5]
					...
					+ nofResult[2] / nofResult[5] + ", DB Update Delay:" + nofResult[3] / nofResult[5]
					+ ", Other Delay:" + nofResult[4] / nofResult[5]);

	}

	//java TransactionLogAnalyseOld /cluster/home/transaction/node_11/extract 2019-02-22_14:42:50 2019-02-22_14:43:50
	public static void main(String[] args) {
		TransactionLogAnalyseOld ins = new TransactionLogAnalyseOld();
