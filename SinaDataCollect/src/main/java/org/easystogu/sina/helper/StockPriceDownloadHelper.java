...
public class StockPriceDownloadHelper {
	...
	public static void main(String[] args) {
		StockPriceDownloadHelper ins = new StockPriceDownloadHelper();
		List<StockPriceVO> list = ins.fetchStockPriceFromWeb("002609");
		StockPriceVO vo = list.get(0);
