...
public class CheckPointStatisticsPrepareData {
	...
	private void prepareCheckPointStatisticsForSkLearnClassifier() {
		...
		for (String date : dates) {
			...
			{
				CheckPointDailyStatisticsVO macdG = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.MACD_Gordon.name());
				CheckPointDailyStatisticsVO macdD = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
			...
			{
				CheckPointDailyStatisticsVO qsddTopArea = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.QSDD_Top_Area.name());
				CheckPointDailyStatisticsVO qsddBottomGordon = checkPointDailyStatisticsTable
						.getByCheckPointAndDate(date, DailyCombineCheckPoint.QSDD_Bottom_Gordon.name());
				CheckPointDailyStatisticsVO qsddBottomArea = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
			...
			{
				CheckPointDailyStatisticsVO wrTopArea = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.WR_Top_Area.name());
				CheckPointDailyStatisticsVO wrBottomGordon = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.WR_Bottom_Gordon.name());
				CheckPointDailyStatisticsVO wrBottomArea = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
			...
			{
				CheckPointDailyStatisticsVO sxG = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.ShenXian_Gordon.name());
				CheckPointDailyStatisticsVO sxD = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
			...
			{
				CheckPointDailyStatisticsVO lzG0 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.LuZao_GordonO_MA43_DownCross_MA86.name());
				CheckPointDailyStatisticsVO lzG1 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.LuZao_GordonI_MA19_UpCross_MA43.name());
				CheckPointDailyStatisticsVO lzG2 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.LuZao_GordonII_MA19_UpCross_MA86.name());
				CheckPointDailyStatisticsVO lzD1 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.LuZao_DeadI_MA43_UpCross_MA86.name());
				CheckPointDailyStatisticsVO lzD2 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
			...
			{
				CheckPointDailyStatisticsVO lzT1 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.Trend_PhaseI_GuanCha.name());
				CheckPointDailyStatisticsVO lzT2 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.Trend_PhaseII_JianCang.name());
				CheckPointDailyStatisticsVO lzT3 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
						DailyCombineCheckPoint.Trend_PhaseIII_ChiGu.name());
				CheckPointDailyStatisticsVO lzT4 = checkPointDailyStatisticsTable.getByCheckPointAndDate(date,
		...
		// QSDD
		CSVFileHelper.write(path + "QSDD.csv", "date,QSDD_Top_Area,QSDD_Bottom_Gordon,QSDD_Bottom_Area".split(","),
				qsddContents);
		// WR
		...
		// LuZaoCross
		CSVFileHelper.write(path + "LuZaoCross.csv",
				"date,LuZao_GordonO_MA43_DownCross_MA86,LuZao_GordonI_MA19_UpCross_MA43,LuZao_GordonII_MA19_UpCross_MA86,LuZao_DeadI_MA43_UpCross_MA86,LuZao_DeadII_MA19_DownCross_MA43"
						.split(","),
				lzCrossContents);
		// LuZaoTrend
		CSVFileHelper.write(path + "LuZaoTrend.csv",
				"date,Trend_PhaseI_GuanCha,Trend_PhaseII_JianCang,Trend_PhaseIII_ChiGu,Trend_PhaseVI_JianCang"
						.split(","),
				lzTrendContents);
	}
