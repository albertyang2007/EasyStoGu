...
/**
 * Create the StockPrice and luzao chart, and luzao statistics (4 phase) chart
 * 
 * @returns {undefined}
 */
function createChart_LuZao_Statistics(stockId, date_price, volume, data_ma19,
		data_ma43, data_ma86, data_1_guancha, data_2_jiancang, data_3_chigu,
		data_4_jiancang) {
	$('#container').highcharts('StockChart', {
